...
const CLOUDINARY_UPLOAD_URL =
  "https://api.cloudinary.com/v1_1/jacob-development/image/upload";
      ...
      <div className="reviewContainer">
        {user ? (
          <div className="reviewFormContainer">
            <form className="reviewForm">
              <div className="reviewTitleContainer">
                <label className="reviewLabel" htmlFor="title">
                  Title:{" "}
                </label>
                <input required onChange={this.handleChange} name="title" />
              </div>

              <div className="reviewRatingContainer">
                <label className="reviewLabel" htmlFor="rating">
                  Rating:
                </label>
              ...
              <div className="reviewBodyContainer">
                <label className="reviewLabel" htmlFor="reviewBody">
                  Review:{" "}
                </label>
                <textarea
                  required
              ...
              <div className="photoContainer">
                ...
                >
                  <div>
                    Drag or click to add a photo of your experience (optional)
                  </div>
                </Dropzone>
              </div>
          ...
          <div className="reviewLoginMessageContainer">
            <div className="reviewLoginMessage">
              Please{" "}
              <span
              ...
              to share a review on this trail!
            </div>
          </div>
        )}
      </div>
