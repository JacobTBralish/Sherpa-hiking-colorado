...
const ArticlesWithData = withData(
  "https://api.nps.gov/api/v1/articles?stateCode=CO&limit=150&api_key=psv6nTyqb2edegMQfeIeAK92ZRlC45pmHnvEqUAH",
  "articles"
)(HomeArticles);
      ...
      <div className="homeSubContainer">
        <div className="welcomeMessageContainer">
          <h1 className="welcomeMessage">
            Welcome to Sherpa Hiking Colorado
            <img
              className="welcomeMessagePicture"
              alt=""
              src="https://statesymbolsusa.org/sites/statesymbolsusa.org/files/primary-images/flagofColoradoCO.jpg"
            />
          </h1>
        </div>
        <div className="imageContainer">
          ...
          <div className="photoCreditContainer">
            <a
              className="photoCredit"
              href="https://www.facebook.com/pg/danicolemanphotography/"
            >
              @Photo by Dani Coleman
            </a>
          </div>
        </div>
        <div>
