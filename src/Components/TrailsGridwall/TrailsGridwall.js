...
class TrailsGridwall extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      trailsNearColoradoSprings:
        JSON.parse(localStorage.getItem("coloradoSprings")) || [],
      trailsNearPagosaSprings:
        JSON.parse(localStorage.getItem("pagosaSprings")) || [],
      trailsNearLeadville: JSON.parse(localStorage.getItem("leadville")) || [],
      trailsNearDenver: JSON.parse(localStorage.getItem("denver")) || [],
      trailsNearBreckenridge:
        JSON.parse(localStorage.getItem("breckenridge")) || [],
